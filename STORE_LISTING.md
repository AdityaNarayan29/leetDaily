# Chrome Web Store Listing — LeetDaily v2.2.2
...
- 30-day activity heatmap with color-coded submission counts
- Streak tracking with fire badge, milestone celebrations (7, 14, 30, 50, 100, 365 days)
- Click your streak to see last 7 days, longest streak, and progress to next milestone
...
4. Configure streak rules and reminders in Settings
...
5. Settings — Streak requirements, reminders, and data export/import
